...
CustomDataTypeWithCommons = (function(superClass) {
  ...
  CustomDataTypeWithCommons.prototype.__renderEditorInputPopover = function(data, cdata) {
    var layout;
  ...
  CustomDataTypeWithCommons.prototype.showEditPopover = function(btn, cdata, layout) {
    var cdata_form, searchsuggest_xhr, suggest_Menu;
    searchsuggest_xhr = {
      "xhr": void 0
    };
    ...
    cdata_form = new CUI.Form({
      ...
      onDataChanged: (function(_this) {
        return function() {
          ...
          return _this.__updateSuggestionsMenu(cdata, cdata_form, suggest_Menu, searchsuggest_xhr);
        };
      })(this)
    }).start();
  ...
  CustomDataTypeWithCommons.prototype.isEmpty = function(data, top_level_data, opts) {
    ...
    if ((ref1 = data[this.name()]) != null ? ref1.conceptName : void 0) {
      return false;
    } else {
      return true;
    }
  ...
  CustomDataTypeWithCommons.prototype.__updateResult = function(cdata, layout) {
    var btn;
    btn = this.__renderButtonByData(cdata);
    return layout.replace(btn, "right");
  };
...
CustomDataTypeCommonFacet = (function(superClass) {
  ...
  CustomDataTypeCommonFacet.prototype.requestFacetWithLimit = function() {
    return {
      limit: this.getLimit(),
